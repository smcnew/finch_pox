...
# Download immune gene sets for chicken. Decided ultimately not to do this
# because preferred an "agnostic" approach
...
cra_iu_kegg <- sort_genes(cra_iu, species = "fortis") %>%
  gseKEGG(., kegg_org, pAdjustMethod = "fdr")
cra_iu_kegg  %>% ridgeplot(fill = "p.adjust")+  ggtitle('Vegetarian: infected vs. uninfected')
